...
import cn.edu.nwpu.unit.*;
import cn.edu.nwpu.subsystem.*;
...
public class TestSuite {
	...
	private void initSystem() {
		...
		usSystem.addStudentToTeam("stu_004", "team_001");
		usSystem.addTeacherToTeam("tea_002", "team_001");
	}
	...
	public void test03() {
		try {
			...
			usSystem.removeStudent("stu_004");
			// 教师的增删改查
			...
			usSystem.removeTeacher("tea_005");
			// 主办方的增删改查
			...
			usSystem.removeOrganizer("org_006");
	...
	public void test05() {
		try {
			...
			List<Activity> acts = asSystem.getActivitiesByDate(date);
			// 符合逻辑才能通过
	...
	public void test06() {
		try {
			...
			List<Team> teams = stu.getTeamList();
	...
	public void test10() {
		try {
			...
			usSystem.addStudentToTeam("stu_004", "team_002");
			usSystem.addTeacherToTeam("tea_002", "team_002");
